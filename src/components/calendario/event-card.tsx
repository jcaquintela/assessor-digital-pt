...
export function EventCard({
  ...
  return (
    <div className={cn("c-card c-card-hover", compact ? "p-2.5" : "p-3.5", interno && "border-l-2 border-l-muted-foreground/40")}>
      ...
      {(onEdit || onArchive) && (
        <div className="mt-2 flex flex-wrap items-center gap-1.5">
          ...
          {onArchive && (
            <button type="button" className="c-badge tap-44 text-destructive" onClick={() => onArchive(e.id, e.titulo)}>
