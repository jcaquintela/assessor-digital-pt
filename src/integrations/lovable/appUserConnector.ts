/**
 * App User Connector helpers — SÓ SERVIDOR.
 *
 * Lê segredos de `process.env` e fala directamente com o connector gateway.
 * Nunca importar isto de um componente/loader: o Vite empacotaria as
 * credenciais no bundle do browser.
 */
