// Cifra a chave de ligação (`lovack_*`) antes de tocar na base de dados.
// A chave nunca fica em texto simples numa coluna — quem olhar para a BD vê
// apenas base64 opaco. Só servidor.
